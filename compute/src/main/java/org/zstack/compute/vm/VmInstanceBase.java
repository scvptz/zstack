...
public class VmInstanceBase extends AbstractVmInstance {
    ...
    protected FlowChain getChangeVmPasswordWorkFlowChain(VmAccountPreference account) {
    ...
    private void changePassword(final APIChangeVMPasswordMsg msg, final SyncTaskChain taskChain) {
        changepasswd(msg, new Completion(taskChain) {
            ...
            public void success() {
                ...
                VmAccountPreference account = new VmAccountPreference(msg.getVmInstanceUuid(),
    ...
    private void changepasswd(final Message msg, final Completion completion){
        ...
        final VmInstanceSpec spec = new VmInstanceSpec();
        spec.setAccountPreference(account);
